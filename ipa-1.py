...
def savings(gross_pay, tax_rate, expenses):
    ...
    final_savings = after_tax_pay - expenses

    return final_savings

print(savings(1000, 0.10, 500))
...
print(material_waste(700, "L", 11, 53))
...
def interest(principal, rate, periods):
    ...
    # Stay within the function. Only use the parameters as input. The function should return your answer.
def interest(principal, rate, periods):
    simple_interest_amount = int(principal*rate*periods)
    final_value = simple_interest_amount + principal 
    
    return final_value

print(interest(50000, 0.03, 2))
...
result_bmi = body_mass_index(weight_imperial, height_imperial)
